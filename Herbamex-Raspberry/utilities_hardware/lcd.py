...
class LCD:
    ...
    def message(self, string, line = 1):
        ...
        # Limitar el texto a 16 caracteres
        string = string[:self.LCD_WIDTH]

        # Calcular el numero de espacios necesarios para centrar el texto
        padding = (self.LCD_WIDTH - len(string)) // 2
        string = ' ' * padding + string

        # Rellenar el texto para que ocupe el ancho maximo
